...
try
{
	...
	{
		//Get record count
		$result = mysql_query("SELECT COUNT(*) AS RecordCount FROM Kennzeichnungen WHERE HundID = " . $_GET["HundID"] . ";");
		$row = mysql_fetch_array($result);
		$recordCount = $row['RecordCount'];

		//Get records from database
		$result = mysql_query("SELECT HundID, Typ, Kennzeichnung FROM Kennzeichnungen WHERE HundID = " . $_GET["HundID"] . ";");
